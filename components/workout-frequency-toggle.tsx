...
export function WorkoutFrequencyToggle({
    ...
    const [internalSelectedDays, setInternalSelectedDays] = useState<DayOfWeek[]>(selectedDays);
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            {days.map((day) => (
              <button
                ...
                className={`rounded-full w-10 h-10 flex items-center justify-center text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 ${
