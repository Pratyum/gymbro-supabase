...
type View = "day" | "3-day" | "5-day" | "week" | "month" | "year";
...
const CalendarWeekView = () => {
    ...
    const days = useMemo(() => {
        ...
        if (view === "5-day") return 5;
        if (view === "3-day") return 3;
        return 7;
    }, [view]);
    ...
    if (!["week", "5-day", "3-day"].includes(view)) return null;
                ...
                {headerDays.map((date, i) => (
                    <div
                        ...
                        className={cn(
                            ...
                            [0, days].includes(i) && "text-muted-foreground/50",
                        )}
                    >
            ...
            {Array.from(Array(25).keys()).map((hour) => {
                return (
                    ...
                    >
                        {now.getHours() === hour && (
                            <div
                                className="absolute z- left-full translate-x-2 w-[69vw] h-[2px] bg-red-500"
                                style={{
